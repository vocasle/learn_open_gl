...
int main()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        object_shader.set_vec3("u_material.ambient", glm::vec3(1.0f, 0.5f, 0.31f));
        object_shader.set_vec3("u_material.diffuse", glm::vec3(1.0f, 0.5f, 0.31f));
        object_shader.set_vec3("u_material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
        object_shader.set_float("u_material.shininess", 32.0f);
        object_shader.set_vec3("u_light.position", light_pos);
        object_shader.set_vec3("u_light.ambient", glm::vec3(0.2f));
        object_shader.set_vec3("u_light.diffuse", glm::vec3(0.5f));
        object_shader.set_vec3("u_light.specular", glm::vec3(1.0f));
